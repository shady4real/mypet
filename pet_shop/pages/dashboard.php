...
<div class="bg-image" style="
     background-image: url('https://images.unsplash.com/photo-1576201836106-db1758fd1c97?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MTN8fHxlbnwwfHx8fA%3D%3D&w=1000&q=80');
            height: 100vh
">
...
<div class="container">
  ...
  <div class="card-deck">
    ...
    <div class="card bg-warning">
      <div class="card-body text-center">
        <p class="card-text">50</p>
        <p class="card-text">TOTAL PET PRODUCTS</p>
      </div>
    </div>
